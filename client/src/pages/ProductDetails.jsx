...
const ProductDetails = () => {
  ...
  const handleImageClick = (index) => {
    const newImageData = { ...data.image };
    const temp = newImageData.link1;
    newImageData.link1 = newImageData[`link${index + 2}`];
    newImageData[`link${index + 2}`] = temp;
    setData((prevData) => ({
      ...prevData,
      image: newImageData,
    }));
    ...
    <section className="product-bg">
      <div className="prod-images-cont">
        <div className="prod-image">
          <img src={data.image.link1} alt="img" />
        </div>
        <div className="pRow">
          {["link2", "link3", "link4"].map((link, index) => (
            <img
              key={link}
              src={data.image[link]}
              alt="img"
      ...
      <div className="prod-details-cont">
        ...
        <h3 className="pprize">
          ₹ {data.price} <span>{data.price * 2}</span>
        </h3>
        <div className="pStar">
