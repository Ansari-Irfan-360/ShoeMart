...
Welcome to ShoeMart – where style meets comfort! ShoeMart is an e-commerce platform dedicated to buying shoes, built on the MERN (MongoDB, Express.js, React.js, Node.js) stack. ShoeMart not only provides a user-friendly interface for customers to browse and purchase shoes but also includes an admin section for managing products, orders, and users. Additionally, it features a secure payment section powered by Stripe.

![ShoeMart Landing Page](./client/src/Images/readmeImage.png)
...
- **Responsive Design:** Enjoy a seamless shopping experience across devices with ShoeMart's responsive design, ensuring optimal performance on desktops, tablets, and smartphones.
...
Explore the project: [ShoeMart](https://ShoeMart197.vercel.app)

To experience ShoeMart as a demo user, navigate to [User Login](https://ShoeMart197.vercel.app/login) and use the following credentials:
...
You can access the admin section by navigating to [Admin Login](https://ShoeMart197.vercel.app/adminlogin) and using the following credentials:
...
Follow these steps to set up ShoeMart on your local machine:

1.  **Clone the Repository:**

    ```bash
    git clone https://github.com/SumilSuthar197/ShoeMart.git
    ```
